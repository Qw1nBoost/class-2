...
try {
    ...
    // PUT запрос
    $updatedPost = $api->put('posts/1', ['title' => 'Updated title', 'body' => 'Updated body', 'userId' => 1]);
    echo "\nPUT Result:\n";
    print_r($updatedPost);
    
    // POST запрос
    $newPost = $api->post('posts', ['title' => 'ApiClient test', 'body' => 'This is a test post from ApiClient', 'userId' => 1]);
    echo "\nPOST Result:\n";
    print_r($newPost);
